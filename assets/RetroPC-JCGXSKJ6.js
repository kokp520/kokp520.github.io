const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/BrowserApp-Dtlnc0Ha.js","assets/index-IyHMlt-o.js","assets/index-D64VDMd1.css","assets/MP3Player-CipNHysm.js","assets/styled-components.browser.esm-UUYn0fxB.js","assets/Terminal-DWWkaoZH.js","assets/FileSystemContext-hElVfD_k.js","assets/Terminal-Bqw_XOwU.css","assets/YahooChat-Dsi8VviG.js","assets/YahooChat-PlnlWHmn.css","assets/PDFViewer-BctV5t1C.js","assets/vscodeEditor-oesKVVRK.js","assets/DitherImageViewer-GVOs4mpq.js","assets/OpenAppStore-DAZcrwU9.js","assets/GameBoyAdvance-uEzYzJa7.js"])))=>i.map(i=>d[i]);
import{a as e,i as t,o as n,r,s as i,t as a,u as o}from"./index-IyHMlt-o.js";import{i as s,n as c,t as l}from"./styled-components.browser.esm-UUYn0fxB.js";import{t as u}from"./FileSystemContext-hElVfD_k.js";var d=o(n(),1),f=a(),p=l`
...
`,gt=s.div`
  ...
  font-size: 12px;
`,_t=({icon:e,title:t,children:n,onClose:r,onFocus:i,defaultSize:a={x:100,y:100,width:320,height:200}})=>{let o=k(),{playCancel:s}=te(),c=typeof window<`u`&&window.innerWidth<=768;return(0,f.jsx)(dt,{default:c?{x:10,y:38,width:Math.min(window.innerWidth-20,380),height:Math.min(window.innerHeight-80,520)}:a,position:c?{x:10,y:38}:void 0,size:c?{width:Math.min(window.innerWidth-20,380),height:Math.min(window.innerHeight-80,520)}:void 0,minWidth:200,minHeight:100,disableDragging:c,enableResizing:!c,dragHandleClassName:`window-title-bar`,onDragStart:()=>i&&i(),children:(0,f.jsxs)(ft,{style:{width:`100%`,height:`100%`},onMouseDown:()=>i&&i(),children:[(0,f.jsxs)(pt,{className:`window-title-bar`,onMouseDown:()=>{try{o()}catch(e){console.warn(`Title bar click sound error (handled):`,e.message)}},children:[(0,f.jsxs)(mt,{children:[e&&(0,f.jsx)(`img`,{src:e,alt:``,width:`18`,height:`18`,"aria-hidden":`true`,style:{marginRight:8,verticalAlign:`middle`}}),t]}),(0,f.jsx)(ht,{children:(0,f.jsx)(`button`,{"aria-label":`Close ${t} window`,onClick:()=>{try{s()}catch(e){console.warn(`Close button sound error (handled):`,e.message)}r&&r()}})})]}),(0,f.jsx)(gt,{children:n})]})})},vt=s.div`
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
